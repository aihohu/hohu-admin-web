...
const TOOL_DESCRIPTION_KEYS: Record<string, App.I18n.I18nKey> = {
  ...
  'user.update': 'page.system.user.editUser',
  ...
  'role.lookup': 'page.ai.chat.toolDescriptions.roleLookup',
  'role.create': 'page.ai.chat.toolDescriptions.roleCreate',
  'role.update': 'page.ai.chat.toolDescriptions.roleUpdate',
  'role.menu_lookup': 'page.ai.chat.toolDescriptions.roleMenuLookup',
  'role.agent_lookup': 'page.ai.chat.toolDescriptions.roleAgentLookup',
  'role.update_menus': 'page.ai.chat.toolDescriptions.roleUpdateMenus',
  'role.update_agents': 'page.ai.chat.toolDescriptions.roleUpdateAgents',
  'dept.count': 'page.ai.chat.toolDescriptions.deptCount',
  'dept.list': 'page.ai.chat.toolDescriptions.deptList',
  'dept.lookup': 'page.ai.chat.toolDescriptions.deptLookup',
  'dept.create': 'page.ai.chat.toolDescriptions.deptCreate',
  'dept.update': 'page.ai.chat.toolDescriptions.deptUpdate',
  'dept.move': 'page.ai.chat.toolDescriptions.deptMove',
