  ...
  namespace I18n {
    ...
    type Schema = {
      ...
      page: {
        ...
        ai: {
          chat: {
            ...
            userId: string;
            targetUser: string;
            updateUserDepartments: string;
            updateUserRoles: string;
            createRole: string;
            updateRole: string;
            updateRoleMenus: string;
            updateRoleAgents: string;
            ...
            roleCode: string;
            roleDefinitionFields: string;
            departmentFields: string;
            completeMenuSet: string;
            completeAgentSet: string;
            ...
            confirmUpdateDeptSummary: string;
            confirmUpdateRolesSummary: string;
            confirmRoleCreateSummary: string;
            confirmRoleUpdateSummary: string;
            confirmRoleMenusSummary: string;
            confirmRoleAgentsSummary: string;
            confirmDeptCreateSummary: string;
            confirmDeptUpdateSummary: string;
            confirmDeptMoveSummary: string;
      ...
      errorCode: {
        ...
        ROLE_DEPT_NOT_FOUND: string;
        ROLE_DEPTS_REQUIRE_CUSTOM_SCOPE: string;
        ROLE_MENU_NOT_FOUND: string;
        AI_DEPT_QUERY_REQUIRED: string;
        AI_DEPT_LOOKUP_LIMIT_INVALID: string;
        AI_DEPT_PARENT_DISABLED: string;
        AI_DEPT_ROOT_CREATE_FORBIDDEN: string;
        AI_DEPT_ROOT_MOVE_FORBIDDEN: string;
        AI_DEPT_SCOPE_ROOT_MOVE_FORBIDDEN: string;
        AI_DEPT_MOVE_CYCLE: string;
        AI_DEPT_MOVE_UNCHANGED: string;
        AI_DEPT_STATUS_AUTHZ_IMPACT_OUT_OF_SCOPE: string;
        AI_DEPT_MOVE_AUTHZ_IMPACT_OUT_OF_SCOPE: string;
        ROLE_DELETE_PROTECTED: string;
        ROLE_DELETE_REFERENCED: string;
        DEPT_DELETE_REFERENCED: string;
        SUPER_ADMIN_REQUIRED: string;
        ...
        AI_USER_ROLE_QUERY_REQUIRED: string;
        AI_USER_ROLE_LOOKUP_LIMIT_INVALID: string;
        AI_PREPARED_ACTION_SNAPSHOT_STALE: string;
        AI_USER_DEPT_AUTHZ_IMPACT_OUT_OF_SCOPE: string;
        AI_SUPER_ADMIN_REQUIRED: string;
        USER_DEPT_NOT_AVAILABLE: string;
        USER_DEPT_SET_DUPLICATE: string;
        USER_ROLE_NOT_AVAILABLE: string;
        USER_ROLE_SET_REQUIRED: string;
        USER_ROLE_SET_DUPLICATE: string;
        USER_ROLE_SELF_ASSIGNMENT_FORBIDDEN: string;
        USER_ROLE_SUPER_ADMIN_REQUIRED: string;
        USER_ROLE_TARGET_OUT_OF_SCOPE: string;
        USER_ROLE_AUTHORITY_EXCEEDED: string;
        AUTHORIZATION_SNAPSHOT_STALE: string;
        USER_PRIMARY_DEPT_MULTIPLE: string;
        USER_PRIMARY_DEPT_REQUIRED: string;
